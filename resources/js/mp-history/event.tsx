...
export default function Event(props: Props) {
  const icons = {
    ...
    'room-created': ['fas fa-plus'],
    'room-disbanded': ['fas fa-times'],
  };
  ...
  return (
    <div className={'mp-history-event'}>
      ...
      <div dangerouslySetInnerHTML={{
        __html: trans(`matches.match.events.${eventType}${user !== null ? '' : '-no-user'}`, { user: userLink }),
      }}
