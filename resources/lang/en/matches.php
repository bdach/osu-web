...
return [
    'match' => [
        ...
        'events' => [
            ...
            'room-created' => ':user created the match',
            'room-disbanded' => 'the match was disbanded',
            'match-created' => ':user created the match',
            'match-disbanded' => 'the match was disbanded',
            'host-changed' => ':user became the host',

            'game-aborted-no-user' => 'the game was aborted',
            ...
            'room-created-no-user' => 'the match was created',
            'room-disbanded-no-user' => 'the match was disbanded',
